...
class TestUsersBlueprint(BaseTestCase):
    ...
    def test_add_user(self):
        ...
        add_user(email='test@test.com', password='test', roles=UserRole.BACKEND_ADMIN)
        with self.client:
    ...
    def test_single_user(self):
        ...
        user = add_user(email='abc@abc.com', password='password', roles=UserRole.BACKEND_ADMIN)
        add_user(email='test@test.com', password='test', roles=UserRole.BACKEND_ADMIN)
        with self.client:
            resp_login = self.client.post(
                '/v1/auth/login',
            ...
            self.assertIn('abc@abc.com', data['data']['email'])
            self.assertIn('success', data['status'])
    ...
    def test_all_users(self):
        ...
        add_user(email='michael@realpython.com', password='password', created_at=created)
        add_user(email='fletcher@realpython.com', password='password')
        created = created + datetime.timedelta(-30)
        add_user(email='test@test.com', password='test', roles=UserRole.BACKEND_ADMIN, created_at=created)
        with self.client:
            resp_login = self.client.post(
                '/v1/auth/login',
                data=json.dumps(dict(
